...
# tako dakle dok qc1 obradjuje bay3  sa 150 kranova onda ce qc2 uzete od qc1 da obradjuje bay1 sa 100 kranova 
# on treba da uzme od njega 12  da bi bio priblizno stanje nakon toga
# nakon obrade 12 kranova stanje u lukama je [88,100,125,138] , QC1 = 12 i QC2 = 12
...
total1 = arr[0] + arr[3] # total za qc1
total2 = arr[1] + arr[2]
...
if how_much_to_take > 0:
    ...
    f1.write('Kran1 obradjuje {0},Kran2 obradjuje {1}\n'.format(arr1[3].name,arr1[0].name))
    f1.write('Stanje posle obrade Bay1 = {0}, Bay2 = {1}, Bay3 = {2}, Bay4 = {3}\n'.format(b1.capacity, b2.capacity, b3.capacity,b4.capacity))
    f1.write('Kran1 obradjuje {0}, Kran2 obradjuje {1}\n'.format(arr1[3].name,arr1[2].name))
    ...
    qc2+=pom1
    f1.write('Stanje posle obrade Bay1 = {0}, Bay2 = {1}, Bay3 = {2}, Bay4 = {3}\n'.format(b1.capacity, b2.capacity, b3.capacity,b4.capacity))
    f1.write('Kran1 obradjuje {0},Kran2 obradjuje {1}\n'.format(arr1[0].name,arr1[1].name))
    ...
    qc2+=pom1
    f1.write('Stanje posle obrade Bay1 = {0}, Bay2 = {1}, Bay3 = {2}, Bay4 = {3}\n'.format(b1.capacity, b2.capacity, b3.capacity,b4.capacity))
    f1.write('Kran1 obradjuje {0},Kran2 obradjuje {1}\n'.format(arr1[3].name,arr1[1].name))
    pom1 = arr1[3].capacity
    qc2+=arr1[1].capacity
    qc1+=arr1[3].capacity
else:
    ...
    qc1+=how_much_to_take
    qc2+=how_much_to_take
    f1.write('Kran1 obradjuje {0},Kran2 obradjuje {1}\n'.format(arr1[1].name,arr1[2].name))
    f1.write('Stanje posle obrade Bay1 = {0}, Bay2 = {1}, Bay3 = {2}, Bay4 = {3}\n'.format(b1.capacity, b2.capacity, b3.capacity,b4.capacity))
    f1.write('Kran1 obradjuje {0}, Kran2 obradjuje {1}\n'.format(arr1[0].name,arr1[1].name))
    pom1 = arr1[0].capacity
    arr1[0].capacity = 0
    ...
    qc2+=pom1
    f1.write('Stanje posle obrade Bay1 = {0}, Bay2 = {1}, Bay3 = {2}, Bay4 = {3}\n'.format(b1.capacity, b2.capacity, b3.capacity,b4.capacity))
    f1.write('Kran1 obradjuje {0}, Kran2 obradjuje {1}\n'.format(arr1[2].name,arr1[1].name))
    qc2+=arr1[2].capacity
    qc1+=arr1[3].capacity
